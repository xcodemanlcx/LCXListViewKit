...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LCXListViewKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/475512103@qq.com/LCXListViewKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '475512103@qq.com' => 'leichunxiang58@163.com' }
  s.source           = { :git => 'https://github.com/475512103@qq.com/LCXListViewKit.git', :tag => s.version.to_s }
